//! Translated from `c/silk/tables_pitch_lag.c` (RFC 6716).
//!
//! Pitch lag iCDF tables and pitch contour iCDF tables.

/// `silk_pitch_lag_iCDF` — 32 entries (2 × (PITCH_EST_MAX_LAG_MS − PITCH_EST_MIN_LAG_MS)).
#[unsafe(no_mangle)]
pub static silk_pitch_lag_iCDF: [u8; 32] = [
    253, 250, 244, 233, 212, 182, 150, 131, 120, 110, 98, 85, 72, 60, 49, 40, 32, 25, 19, 15, 13, 11, 9, 8, 7, 6, 5, 4, 3, 2,
    1, 0,
];
...
pub static silk_pitch_contour_iCDF: [u8; 34] = [
    223, 201, 183, 167, 152, 138, 124, 111, 98, 88, 79, 70, 62, 56, 50, 44, 39, 35, 31, 27, 24, 21, 18, 16, 14, 12, 10, 8, 6,
    4, 3, 2, 1, 0,
];
...
#[unsafe(no_mangle)]
pub static silk_pitch_contour_10_ms_iCDF: [u8; 12] = [165, 119, 80, 61, 47, 35, 27, 20, 14, 9, 4, 0];
