...
pub fn silk_nlsf2a(a_q12: &mut [i16], nlsf: &[i16], d: i32) {
    ...
    while k < d {
        ...
        let f_int = nlsf[k as usize] as i32 >> (15 - 7);

        /* f_frac, range: 0..255 */
        let f_frac = nlsf[k as usize] as i32 - silk_lshift(f_int, 15 - 7);
    ...
    if i == 10 {
        ...
        let mut k = 0i32;
        while k < d {
            a_q12[k as usize] = silk_sat16(silk_rshift_round(a32_qa1[k as usize], QA + 1 - 12)) as i16; /* QA+1 -> Q12 */
            a32_qa1[k as usize] = silk_lshift(a_q12[k as usize] as i32, QA + 1 - 12);
            k += 1;
        }
    } else {
        let mut k = 0i32;
        while k < d {
            a_q12[k as usize] = silk_rshift_round(a32_qa1[k as usize], QA + 1 - 12) as i16; /* QA+1 -> Q12 */
            k += 1;
        }
    }
