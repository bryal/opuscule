//! Translated from `c/silk/tables_LTP.c` (RFC 6716).
//!
//! Long-Term Prediction (LTP) codebook tables: iCDFs, bit-rate tables,
//! and vector-quantized gain codebooks for the three LTP codebook sizes
//! (8, 16, 32 entries).
